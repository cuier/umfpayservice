...
module.exports = {
    /**子商户入网请求URL*/
    //获取token
    UMF_RESTPAY_AUTHORIZE:"/spay_restPay/oauth/authorize",
    //添加子商户
    UMF_RESTPAY_ADDCHILDMERINFO:"/spay_restPay/addChildMerInfo",
    //资质上传
    UMF_RESTPAY_UPLOADCHILDFILE:"/spay_restPay/uploadChildFile",
    //驳回状态下商户信息修改（修改后需重新上传资质）
    UMF_RESTPAY_CHANGECHILDREBUT:"/spay_restPay/changeChildRebut",
    //子商户审核状态查询
    UMF_RESTPAY_SELECTCHILDMERSTATE:"/spay_restPay/selectChildMerState",
    ...
    /**历史订单查询*/
    MER_ORDER_INFO_QUERY: "service,sign_type,charset,mer_id,version,mer_date",
    /**退费订单状态查询*/
