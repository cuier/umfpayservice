...
function SignUtil() {
    ...
    this.addChildMerSign = function (signPlain,priKeyPath) {
        ...
        log.info(signPlain)
        try {
            // var privateKey = fs.readFileSync('/Users/MYFILE/Documents/Cuilijuan/SAAS_SDK/Node.JS/60000100_key/60144402_.key.pem', 'utf8') //测试
            var privateKey = fs.readFileSync('/Users/MYFILE/Documents/Cuilijuan/SAAS_SDK/Node.JS/60000100_key/60038402_.key.pem', 'utf8') //生产
